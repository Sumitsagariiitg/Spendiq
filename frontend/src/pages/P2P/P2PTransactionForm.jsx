...
// P2P transaction types configuration
const P2P_TYPES = [
  {
    value: "lent",
    label: "💸 Lent Money",
...
const P2PTransactionForm = ({ isOpen, onClose, onSuccess }) => {
  ...
  const selectedType = P2P_TYPES.find((type) => type.value === formData.type);
  const showDueDate = formData.type === "lent" || formData.type === "borrowed";
  const isFormValid = formData.amount && formData.personName;

  return (
    <div
      className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center p-3 sm:p-4 z-[9999]"
      style={{ margin: 0 }}
    >
      <div className="bg-white rounded-lg sm:rounded-xl shadow-2xl w-full max-w-2xl max-h-[95vh] sm:max-h-[90vh] overflow-hidden flex flex-col">
        {/* Header - Fixed */}
              ...
              <div className="space-y-4 sm:space-y-6">
                    ...
                    {P2P_TYPES.map((type) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="text-sm font-medium text-gray-900 mb-0.5 sm:mb-1">
                            {type.label}
                          </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        min="0.01"
                        required
                        className="w-full pl-7 sm:pl-8 pr-3 sm:pr-4 py-2.5 sm:py-3 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      />
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full pl-9 sm:pl-10 pr-3 sm:pr-4 py-2.5 sm:py-3 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none"
                    />
                  </div>
                </div>
                ...
                {selectedType && isFormValid && (
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 sm:p-4">
                    <h4 className="text-sm font-medium text-blue-900 mb-1.5 sm:mb-2">
                      Transaction Summary
                    </h4>
                    <p className="text-xs sm:text-sm text-blue-800">
                      <span className="font-medium">
                        {selectedType.label.replace(/[^a-zA-Z\s]/g, "").trim()}
                      </span>
                      <br />
          ...
          <div className="border-t border-gray-200 p-4 sm:p-6 bg-white flex-shrink-0">
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <button
                type="button"
                onClick={onClose}
                className="w-full sm:flex-1 px-4 py-2.5 sm:py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 font-medium transition-colors text-sm sm:text-base order-2 sm:order-1"
              >
                Cancel
              </button>
              <button
                ...
                className="w-full sm:flex-1 px-4 py-2.5 sm:py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:bg-gray-300 disabled:cursor-not-allowed font-medium transition-colors text-sm sm:text-base order-1 sm:order-2"
              >
